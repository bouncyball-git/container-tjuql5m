...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-tjuql5m.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-tjuql5m.containers.anotherwebservice.com/
...
```
git clone git@github.com:bouncyball-git/container-tjuql5m.git
cd container-tjuql5m
```
...
```
docker attach container-tjuql5m
```
